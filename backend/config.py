"""Configuration constants for stroke prediction model training."""
...
# Risk level thresholds for prediction service
RISK_THRESHOLDS = {
    "low": 0.3,
    "medium": 0.6,
}

# Important features based on research paper
IMPORTANT_FEATURES = [
    "age",
    "bmi",
    "avg_glucose_level",
...
# Required patient data fields for API validation
...
# Model hyperparameter grids for RandomizedSearchCV
PARAM_GRIDS = {
    "Random Forest": {
...
# Model configurations for API auto-discovery
MODEL_CONFIGS = [
    {
        "id": "drop_imbalanced",
