...
import { Header, PatientForm, AnalysisResult, ModelSelector } from './components';
import { PatientData, RiskAnalysis, ModelInfo, DEFAULT_PATIENT_DATA } from './types';
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col">
                ...
                {!isLoadingModels && availableModels.length === 0 && (
                    <div className="mb-6 bg-yellow-50 border border-yellow-200 text-yellow-800 px-4 py-3 rounded-lg">
                        ...
                        <p className="mt-2 text-sm">
                            Run: <code className="bg-yellow-100 px-2 py-1 rounded">cd backend && python -m training.train --imputation drop --balancing imbalanced</code>
                        </p>
                    </div>
                )}
            ...
            <footer className="bg-white border-t border-gray-200 py-6 mt-auto">
                <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-500">
                    <p>StrokeGuard AI System. All rights reserved.</p>
